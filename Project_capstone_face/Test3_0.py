...
class Face_Recog:
    def __init__(self, master):
        ...
        self.id_txt = Entry(self.master, width=20, bg="black",
                         fg="white", font=('comic', 15, ' bold '), bd = 5, insertbackground = 'white')
        ...
        self.nm_txt = Entry(self.master,
                             fg="white", bg="black", font=('comic', 15, ' bold '), bd = 5, insertbackground = 'white')
        ...
        self.clearButton = Button(self.master, text="Clear All", command=self.clear, fg="white", bg="black",
                                activebackground="Red", font=('times', 15, ' bold '))
        self.clearButton.place(x=500, y=95)
    ...
    def TakeImages(self):
        ...
        if ( id.isnumeric() and name.isalpha() ): #check id is int
            ...
            while True:
                ...
                faces = face_cascade.detectMultiScale(gray, scaleFactor=1.2, minNeighbors=5)  # returns coordinates else return None
                #SF
...
copyWrite = Text(root, background=root.cget("background"),
                 borderwidth=0, font=('times', 10, 'italic bold underline'))
copyWrite.configure(fg="red")
copyWrite.place(x=320, y=480)
root.mainloop()